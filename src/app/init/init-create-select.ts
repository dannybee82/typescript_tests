import { CreateSelectElement } from "../functions/create-select-element";
import { SharedChangeColor } from "../functions/shared-change-color";

export class InitCreateSelect {
